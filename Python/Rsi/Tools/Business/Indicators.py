...
def calculate_hourly_volume(currency_pair: BotCurrencyPair, dataframe: DataFrame, rsi_column: str, current_time: datetime, timeframe: GateioTimeFrame, tolerance_bandwidth: float):
    """
