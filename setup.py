...
setup(
    name='framework',  # Nom de votre projet
    ...
    url='https://github.com/venantvr/Python.Rsi.Framework.git',  # URL du projet (par exemple, GitHub)
    packages=find_namespace_packages(include=['framework.*']),  # Trouve tous les packages dans le répertoire courant
    classifiers=[
