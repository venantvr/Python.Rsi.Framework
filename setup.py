...
setup(
    name='Python.Rsi.venantvr',  # Nom de votre projet
    ...
    packages=find_namespace_packages(include=['Python.Rsi.venantvr.*']),  # Trouve tous les packages dans le répertoire courant
    classifiers=[
